...
type Draft = { course_name: string; course_code: string; course_cluster?: string | null; sks_total: number; sks_theory: number; sks_practice: number; semester: string; preparation_date: string | Date; lecturers: { name:string; role:string; nidn:string }[]; weekly_plans: WeeklyRow[] };

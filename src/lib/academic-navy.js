...
/**
 * academic-navy theme — built by `bunx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { academicNavyTheme } from './academic-navy';
 *   import './academic-navy.css';
 */
export const academicNavyTheme = {
  name: 'academic-navy',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#FAFCFF, #191C22)",
    "--color-background-body": "light-dark(#EDF1FA, #0E1118)",
    "--color-background-card": "light-dark(#FAFCFF, #191C22)",
    "--color-background-popover": "light-dark(#FAFCFF, #2D3037)",
    "--color-background-muted": "light-dark(#191C220D, #191C2280)",
    "--color-accent": "light-dark(#1E3A5F, #234876)",
    "--color-accent-muted": "light-dark(#1E3A5F33, #23487633)",
    "--color-neutral": "light-dark(#191C221A, #DFE2EC33)",
    "--color-overlay": "light-dark(#191C2266, #191C2299)",
    "--color-overlay-hover": "light-dark(#191C220D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#191C221A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#191C22, #DFE2EC)",
    "--color-text-secondary": "light-dark(#414753, #A5ABB9)",
    "--color-text-disabled": "light-dark(#8B919E, #595E6B)",
    ...
    "--color-icon-primary": "light-dark(#191C22, #DFE2EC)",
    "--color-icon-secondary": "light-dark(#414753, #A5ABB9)",
    ...
    "--color-border": "light-dark(#191C221A, #EDF1FA1A)",
    "--color-border-emphasized": "light-dark(#8B919E, #636875)",
    ...
    "--color-track": "light-dark(#A5ABB9, #414753)"
  },
  localTokens: {
  ...
  __localTokenLineage: ["neutral","academic-navy"],
  components: {
    "heading": {
      "level:1": {
